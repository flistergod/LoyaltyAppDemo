...
<div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-9">
                <img src="<?=base_url('assets/Imagens/bizdirect.png');?>">
                <p class="frase"> O melhor aplicativo <br> para gerir as suas lojas favoritas... </p>
                <a href="<?= base_url('index.php/auth/get_app')?>"><img class="w-25 pt-3" src="<?=base_url('assets/Imagens/googleplay.png');?>"></a>
            </div>
            <div class="col-xs-12 col-sm-3 pt-5">
              <img class="img-fluid w-75 h-100 pt-3" src="<?=base_url('assets/Imagens/app.png');?>">

            </div>
        </div>
       <!-- <div class="row">
            <div class="mr-auto mt-3">
                <p class="frase"> O melhor aplicativo <br> para gerir as suas lojas favotitas... </p>
            </div>
        </div>-->
    </div>
<!-- Footer -->
