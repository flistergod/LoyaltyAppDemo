                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="carimbos" class="form-control"
                                    id="carimbos" placeholder="Número de Carimbos">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" name="produto" class="form-control"
                                    id="produto" placeholder="Produto-Alvo">
                    </div>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-4"></div>
                    <a href="<?= base_url('index.php/cartao_ctl/my_card')?>"><button  type="button" class="btn btn-danger" id="meucartao" name="meucartao"> Meus Cartões</button></a>
                <div class="col-md-6">
                    <button style="color: black; border:none; line-height:normal;" type="submit" value="submit" class="btn btn-success" id="cartao" name="card_creation"> Guardar Alterações</button>
                </div>
            </div>
        </form>
    </div>
