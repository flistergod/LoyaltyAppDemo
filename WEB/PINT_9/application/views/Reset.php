...
<html lang="en">
  ...
  <div class="container mt-5 pt-5">
      <form class="form-horizontal" method="POST" action="<?= base_url('index.php/auth/updatepass')?>">
            <div class="row">
            ...
            <div class="row mt-3">
                <div class="col-md-4 pt-1 field-label-responsive text-right">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button style="color: black; border:none; line-height:normal;" type="submit" class="btn btn-success" id="update_pass" name="update_pass">Atualizar Password </button>
                </div>
            </div>
        </form>
    </div>
    ...
    <footer class="page-footer fixed-bottom font-small bg-light">
        ...
        <!-- Footer Elements -->
        <div class="container pt-4 mt-0 mb-0">
