...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
        ...
        <form class="form-horizontal" method="POST" action="<?php echo site_url('User/insert/'.$cli->ID) ?>">
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <h2 class="text-center">Inserir Transação</h2>
                    <hr>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 text-right pt-2 field-label-responsive">
            ...
            <div class="row">
                <div class="col-md-3 text-right pt-2 field-label-responsive">
                    <label for="name">Descrição da Transação</label>
                </div>
               <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group mt-2 mb-2 mr-sm-2 mb-sm-0">
                            ...
                            <textarea type="text" name="descricaotransação" class="form-control"
                                    id="descricaotransação" placeholder="Faça uma pequena descrição da Transação onde coloque os produtos e o preço..."></textarea>
                        </div>
                    </div>
                </div>            
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button style="color: black; background:orange; border:none; line-height:normal;" type="submit" class="btn btn-success" id="transação" name="transacao" value="submit">Submeter</button>
                </div>
            </div>
        </form>
    </div>
