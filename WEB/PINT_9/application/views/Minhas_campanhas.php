...
<div class="row mr-0">
    <div class="col-4 mt-5 ml-3">
        <p class="frase"> Minhas Campanhas </p>
    </div>
    <div class="col-7 mt-5 ml-3">
       <a href="<?php echo base_url(); ?>index.php/Campanha_ctl/Camp"><button type="button" class="btn btn-danger float-right mt-2"> Criar Campanha</button></a>
    </div>
</div>
...
<table class="col-12 col-md-10 ml-auto mr-auto table table-bordered table-striped mt-5">
  <thead class="black white-text">
   ...
   <?php 
   /*usa-se o foreach para apresentar os dados na tabela */
  ...
  <tbody>
    <tr>
      <th scope="row"><?php echo $row->ID_CAMPANHA; ?></th>
      ...
      <td>
            <a href="<?php echo site_url('campanha_ctl/editar_camp/'.$row->ID_CAMPANHA) ?>"><button type="button" class="btn btn-warning"><i class="far fa-edit"></i></button></a>
            <a href="<?php echo site_url('campanha_ctl/delete_Camp/'.$row->ID_CAMPANHA) ?>"><button type="button" id="apagarCamp" class="btn btn-danger" onclick="return confirm('Tem a Certeza?')"title="Eliminar" value="Eliminar"><i class="far fa-trash-alt"></i></button></a>
        </td>
    </tr>
    <?php
            }
