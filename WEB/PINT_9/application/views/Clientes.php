...
<table id="example" class="display">
        ...
        <tbody>
            ...
            <tr>
                <!-- usa-se este tipo de href como por exemplo:<?php echo site_url('user/loadcli_profile/'.$row->ID) ?> para transportar para a função o ID do client -->
                <td><a href="<?php echo site_url('user/loadcli_profile/'.$row->ID) ?>"><?php echo $row->ID;?></a></td>
                <td><a href="<?php echo site_url('user/loadcli_profile/'.$row->ID) ?>"><?php echo $row->NOME;?></a></td> 
                <td><a href="<?php echo site_url('user/loadcli_profile/'.$row->ID) ?>"><?php echo $row->EMAIL;?></a></td>
                <td><a href="<?php echo site_url('user/loadcli_profile/'.$row->ID) ?>"><?php echo $row->TELEFONE;?></a></td>
                <td><a href="<?php echo site_url('user/loadcli_profile/'.$row->ID) ?>"><?php echo $row->MORADA;?></a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
...
<footer class="page-footer fixed-bottom font-small bg-light">
    ...
    <script>
        /*uso isto para usar o link dos DataTable onde arranjo os dados numa tabela*/
