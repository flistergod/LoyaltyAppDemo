                        ...
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                <div class="userData ml-3">
                                    <h2 class="d-block pt-4 pl-3" style="font-size: 1.5rem; font-weight: bold">Nome da Empresa: <?php echo $infoemp->NOMEEMPRESA; ?></h2>
                                </div>
                                <div class="ml-auto">
                            ...
                            <div class="col-12">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab">
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Data de Registo</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                <?php echo $infoemp->DATA_REGISTO ?>
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">NIF</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                <?php echo $infoemp->NIF ?>
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Descrição Da Empresa</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                <?php echo $infoemp->DESCRICAO ?>
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Nome da Empresa</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                <?php echo $infoemp->NOMEEMPRESA ?>
                                            </div>
                                        </div>
                                        <hr />
                                    </div>
