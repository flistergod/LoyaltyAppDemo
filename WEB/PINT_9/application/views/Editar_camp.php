...
<div class="row mr-0">
    <div class="col-4 mt-5 ml-3">
        <p class="frase"> Edite a sua Campanha </p>
    </div>
</div>
<div class="container mb-5">
    <!--<form action="<?php echo site_url('campanha_ctl/editar_camp') ?>" method="post">
    <input type="hidden" name="id_campanha" value="<?php echo $campanha->ID_CAMPANHA ?>">
    <p><input type="text" name="text_desconto" value="<?php echo $campanha->DESCONTO ?>"></p>
    <p><input type="text" name="text_titulo" value="<?php echo $campanha->TITULO ?>"></p>
    <p><input type="submit" value="Atualizar"></p>
    <a href="<?php echo site_url('campanha_ctl/my_camp') ?>">Cancelar</a>
    </form>-->
    <form class="form-horizontal" method="POST" action="<?php echo site_url('campanha_ctl/editar_camp') ?>"> 
        <input type="hidden" name="id_campanha" value="<?php echo $campanha->ID_CAMPANHA ?>">
            <div class="row mt-5 ml-5">
                ...
                <div class="col-md-4">
                    <input type='text' name="inicio_update"  id="date" value="<?php echo $campanha->DATA_INICIO ?>">
                </div>
                <div class="col-md-1 field-label-responsive">
                    <label for="name">Até:</label>
                </div>
                <div class="col-md-4">
                    <input type='text' name="fim_update"  id="date2" value="<?php echo $campanha->DATA_FIM ?>">
                </div>
            </div>
            <div class="row mt-4 ml-5">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                            <input type="text" name="desconto_update" class="form-control"
                                    id="desconto" placeholder="Desconto" value="<?php echo $campanha->DESCONTO ?>">
                    </div>
                </div>
                <div class="col-md-1 field-label-responsive">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                            <input type="text" name="produtos_update" class="form-control"
                                    id="produtos" placeholder="Produtos" value="<?php echo $campanha->PRODUTO_ALVO ?>">
                    </div>
                </div>
            </div>
            <div class="row mt-2 ml-5">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                            <input type="text" name="titulo_update" class="form-control"
                                    id="titulo" placeholder="Titulo da Campanha" value="<?php echo $campanha->TITULO ?>">
                    </div>
                </div>
                <div class="col-md-1 field-label-responsive">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                            <input type="text" name="localidade_update" class="form-control"
                                    id="localidade" placeholder="Localidade" value="<?php echo $campanha->LOCALIZACAO ?>">
                    </div>
                </div>
            </div>
            <div class="row mt-2 ml-5">
                ...
                <div class="col-md-4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="genero_update" id="genero" value="Homem">
                        <label class="form-check-label" for="genero">Homem</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="genero_update" id="genero2" value="Mulher">
                        <label class="form-check-label" for="genero2">Mulher</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="genero_update" id="genero3" value="Outro">
                        <label class="form-check-label" for="genero3">Outro</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="genero_update" id="genero4" value="Todos">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="estado_civil_update" id="estado_civil" value="Solteiro">
                            <label class="form-check-label" for="estado_civil">Solteiro/a</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="estado_civil_update" id="estado_civil2" value="Casado">
                            <label class="form-check-label" for="estado_civil2">Casado/a</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="estado_civil_update" id="estado_civil3" value="Ambos">
            ...
            <div class="row mt-2 ml-5">
                ...
                <div class="col-md-4">
                   <div class="form-group">
                        <select class="form-control" id="idade" name="idade_update" value="<?php echo $campanha->IDADE ?>">
                            <option>18+</option>
                            <option>30+</option>
                            <option>40+</option>
                            <option>50+</option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="animais_update" id="animais" value="Sim">
                            <label class="form-check-label" for="animais">Sim</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="animais_update" id="animais2" value="Não">
